...
RtcDateTime sekarang;//tidak digunakan now karena bentrok dengan TimeLib.h
...
char hariHijriah[][8] = {"SABT", "AHAD", "ISNAIN", "SULASA", "ARBI'A", "KHAMIS", "JUMU'AH", "SABT"};
...
void BacaRTC() {
  ...
  rJam = sekarang.Hour();
  rMen = sekarang.Minute();
  rDet = sekarang.Second();
  rTgl = sekarang.Day();
